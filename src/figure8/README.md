# MAVROS Offboard Figure-8 Trajectory Control

This ROS node implements an autonomous figure-8 (infinity symbol) flight path for PX4-based drones using the MAVROS package. The trajectory is generated using a Lissajous curve with specific frequency ratios.

[简体中文](README_CN.md)

## Functionality
* **Trajectory Generation:** Pre-calculates a figure-8 path using Lissajous curve mathematics with 100 discrete waypoints using NumPy.
...
* **Continuous Looping:** Once the pattern completes, the trajectory index resets, creating an infinite flight loop.

## Implementation Logic

### 1. Trajectory Pre-calculation
The figure-8 is generated using a Lissajous curve before the control loop starts:
...
- Altitude fixed at $2.5m$
- The frequency ratio of 1:2 creates the figure-8 shape
